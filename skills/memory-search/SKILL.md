...
1. Use the qmd MCP `query` tool to semantically search across memory files.
2. Use `get` to pull specific lines from matched files.
3. Ground your response with the results.

Search broadly. If nothing is found, say so.
